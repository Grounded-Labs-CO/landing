    ...
    <header className="sticky top-0 z-40 w-full border-b bg-[#f6f2ea]/80 backdrop-blur">
      <div className="mx-auto flex h-14 max-w-[1120px] items-center justify-between px-6">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="hidden sm:inline text-xs text-[#6f7d74]"><span className="text-[#c86f3d] italic">No hype.</span> Solo inteligencia artificial que entiende tu mundo.</span>
        </Link>
        <nav className="flex items-center gap-3 text-sm">
          <Link href="/workshops/finanzas-personales-ia" className="hidden md:inline text-[#4e5b53] hover:text-[#236b4b]">Workshops</Link>
